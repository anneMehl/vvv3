...
Cand.models[[9]] <- lmer(mean_gnmds2 ~ method + year + caco + dist_int_veg + exposure + (1|site_id_new.x), data = env.var_full_sub5, REML = F)
...
# Mod2 19 282.13      0.00  0.78   0.78 -122.07
# Mod3 18 284.93      2.80  0.19   0.97 -124.47
# Mod1 28 289.37      7.23  0.02   0.99 -116.68
# Mod4 24 290.73      8.60  0.01   1.00 -121.37
