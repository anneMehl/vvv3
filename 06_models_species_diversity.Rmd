...
Axis scales retrieved from ordination with dataset species_sub5 epsilon 0.9 and k=3 (load("processdata/envvar_full_sub5_2020_08_27.rda"))
```{r}
...
## -------------------- Linear mixed model with gmnds axis scores from AXIS 1 as response (all plots) -------------------
Axis scales retrieved from ordination with dataset species_sub5 epsilon 0.95 and k=4 (load("processdata/envvar_full_sub5_2020_08_31.rda"))
