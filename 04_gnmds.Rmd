...
for(i in 1:length(uid)) {
  mean_gnmds3[i] <- mean(gnmds3[env.var_full_sub5$id == (uid[i])], na.rm=T)
}
mean_gnmds3
...
for(i in 1:length(uid)) {
  mean_gnmds4[i] <- mean(gnmds4[env.var_full_sub5$id == (uid[i])], na.rm=T)
}
mean_gnmds4
...
save(env.var_full_sub5, file = "env.var_full_sub5_095_k4_2020_09_10.rda")
