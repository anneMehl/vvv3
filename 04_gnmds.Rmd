...
load("output/species_sub10_3_2020_208_27.rda")
load("output/env.var_sub10_2_2020_208_27.rda")
...
# Legger på vektorer for environmental variables
  mds.z <- envfit(scores(mds.best, choices = 1:2, origin = TRUE), env.var_sub5, 999)
...
save(mds.z, file="env.var_fit_e09_2020_08_31.rda")
